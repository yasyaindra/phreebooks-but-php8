...
<ul>
  <li>An existing mysqli database table with access information</li>
...
define('MSG_ERROR_INNODB_NOT_ENABLED','mysqli InnoDB engine is not installed!. PhreeBooks requires the transaction capability of mysqli\'s InnoDB engine to operate properly.');
