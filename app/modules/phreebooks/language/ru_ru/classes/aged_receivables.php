...
// Version: 3.7
// +-----------------------------------------------------------------+
// Path: //modules/phreebooks/language/ru_ru/classes/aged_receivables.php
...
define('RW_AR_SALES_TAX','Налог на продажу');
define('RW_AR_TAX_AUTH','Налоговые органы');
define('RW_AR_INV_TOTAL','Сума Счета');
define('RW_AR_BALANCE_DUE','Дебетовое сальдо');
define('RW_AR_CUR_CODE','Код валюты');
define('RW_AR_CUR_EXC_RATE','Курс обмена');
define('RW_AR_SO_NUM','Номер Заказа');
define('RW_AR_INV_NUM','Номер счета');
define('RW_AR_PO_NUM','Номер Закупки');
define('RW_AR_SALES_REP','Отдел продаж');
define('RW_AR_AR_ACCT','Дт счет');
define('RW_AR_BILL_ACCT_ID','ID плательщика');
define('RW_AR_BILL_ADD_ID','ID адреса плат.');
...
define('RW_AR_SHIP_PRIMARY_NAME','Имя получателя');
define('RW_AR_SHIP_CONTACT','Контакты получателя');
...
define('RW_AR_ACCOUNT_NUMBER','Номер аккаунта');
