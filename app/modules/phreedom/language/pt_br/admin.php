...
define('INV_LABEL_TIME_STAMP_FIELD','Carimbo Tempo');
define('INV_LABEL_DATE_TIME_FIELD','Fata e Hora');
define('INV_LABEL_CHECK_BOX_FIELD','Check Box <br>(Sim ou Nãoe)');
...
define('INV_LABEL_IMAGE_LINK','Nome Arquivo Imagem');
define('INV_LABEL_HTML_TEXT_FIELD','Código HTML');
define('INV_LABEL_HYPERLINK','Hyper-Link');
define('INV_LABEL_TEXT_FIELD','Campo Texto');
define('INV_LABEL_MAX_255','(para tamanhos menores que 256 Caracteres)');
define('INV_LABEL_CHOICES','Entre String Seleção');
define('INV_LABEL_FIXED_255_CHARS','Fixo em no máximo 255 Caracteres');
define('INV_LABEL_DEFAULT_TEXT_VALUE','Valor Padrão: ');
...
define('ASSETS_FIELD_RESERVED_WORD','O nome de campo digitado é uma palavra reservada do mysqli, por favor entre um novo nome!');
...
define('INV_CATEGORY_MEMBER','Membor Aba:');
...
define('SETUP_CO_MGR_COPY_HDR','Entre a informatção base de dados para a nova empresa. (Precisa se adequar às convenções mysqli, tipicamente 8-12 caracteres alfanuméricos) Este nome é usado como nome base de dados e será acrescentado ao diretório para conter dados específicos da empresa. A base de dados deve ser criada antes da criação da empresa.');
