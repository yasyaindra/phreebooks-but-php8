	...
	switch ($_REQUEST['action']) {
		...
		case 'install':
			...
			if (!$error) { // write the includes/configure.php file
			  ...
			  fclose($fp);
			  @chmod('../includes/configure.php', 0755);
			}
		...
		case 'finish':
			...
			break;
		case 'open_company':
			define('HTTP_SERVER',  'DEFAULT_HTTP_SERVER');
			define('HTTPS_SERVER', 'DEFAULT_HTTPS_SERVER');
			define('ENABLE_SSL_ADMIN', 'DEFAULT_ENABLE_SSL_ADMIN');
