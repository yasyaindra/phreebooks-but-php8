...
define('RW_BO_INV_TOTAL','Invoice Amount');
define('RW_BO_BALANCE_DUE','Balance Due');
define('RW_BO_CUR_CODE','Currency Code');
...
define('RW_BO_BILL_ADDRESS1','Bill Address 1');
define('RW_BO_BILL_ADDRESS2','Bill Address 2');
define('RW_BO_BILL_CITY','Bill City/Town');
