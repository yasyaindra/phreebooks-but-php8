...
// This script updates all beta releases to the first production release.
  ...
  // Release 1.0 to 1.1
  if ($db_release == '1.1') { // go to Release 1.1
	...
	$fields = mysqli_list_fields(DB_DATABASE, TABLE_CURRENT_STATUS);
  ...
  if ($db_release == '1.1') { // go to Release 1.2
	...
	$fields = mysqli_list_fields(DB_DATABASE, TABLE_SHIPPING_LOG);
	$columns = mysqli_num_fields($fields);
	$field_array = array();
	for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
	...
	$fields = mysqli_list_fields(DB_DATABASE, TABLE_JOURNAL_MAIN);
	$columns = mysqli_num_fields($fields);
	$field_array = array();
	for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
	...
	$fields = mysqli_list_fields(DB_DATABASE, TABLE_INVENTORY_HISTORY);
	$columns = mysqli_num_fields($fields);
	$field_array = array();
	for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
	...
	if (!mysqli_num_rows(mysqli_query("SHOW TABLES LIKE '" . TABLE_INVENTORY_MS_LIST . "'"))) {
	...
	if (mysqli_num_rows(mysqli_query("SHOW TABLES LIKE '" . TABLE_ADDRESS_FORMAT . "'"))) {
	...
	$fields = mysqli_list_fields(DB_DATABASE, TABLE_ZONES);
	$columns = mysqli_num_fields($fields);
	$field_array = array();
	for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
  ...
  if ($db_release == '1.3') { // go to Release 1.3.1
	...
	if (!mysqli_num_rows(mysqli_query("SHOW TABLES LIKE '" . TABLE_ACCOUNTS_NOTES . "'"))) {
...
$fields = mysqli_list_fields(DB_DATABASE, TABLE_ACCOUNTS);
$columns = mysqli_num_fields($fields);
$field_array = array();
for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
...
$fields = mysqli_list_fields(DB_DATABASE, TABLE_REPORTS);
$columns = mysqli_num_fields($fields);
$field_array = array();
for ($i = 0; $i < $columns; $i++) $field_array[] = mysqli_field_name($fields, $i);
...
if (mysqli_num_rows(mysqli_query("SHOW TABLES LIKE '" . TABLE_ACCOUNTS . "'"))) {
