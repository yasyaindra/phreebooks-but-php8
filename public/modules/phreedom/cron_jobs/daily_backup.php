...
{
	shell_exec("/usr/bin/mysqlidump --opt -u ".DB_SERVER_USERNAME." -p".DB_SERVER_PASSWORD." ".DB_NAME." > ".WEB_ROOT."/my_files/backups/bu-".$company_name."-".date("Ymd").WEB_ROOT."/my_files/".$company_name."-".date("Ymd").".sql");
		
	if(DEBUG)
	{
		echo "\n\n/usr/bin/mysqlidump --opt -u ".DB_SERVER_USERNAME." -p".DB_SERVER_PASSWORD." ".DB_NAME." > ".WEB_ROOT."/my_files/backups/bu-".$company_name."-".date("Ymd").WEB_ROOT."/my_files/".$company_name."/db-".$company_name."-".date("Ymd").".sql";
	}
}
else
{
	shell_exec("/usr/bin/mysqlidump --opt -u ".DB_SERVER_USERNAME." ".DB_NAME." > ".WEB_ROOT."/my_files/backups/bu-".$company_name."-".date("Ymd").WEB_ROOT."/my_files/".$company_name."/db-".$company_name."-".date("Ymd").".sql");
	
	if(DEBUG)
	{
		echo "\n\n/usr/bin/mysqlidump --opt -u ".DB_SERVER_USERNAME." ".DB_NAME." > ".WEB_ROOT."/my_files/backups/bu-".$company_name."-".date("Ymd").WEB_ROOT."/my_files/".$company_name."/db-".$company_name."-".date("Ymd").".sql";
	}
}
